...
Server.prototype.handleConfigurationRequest = function(dispatched_request) {
	...
	if (url == "/") {
	  ...
	  csd = csd + "Last Message " + bridge.lastMessage;
	  
	  dispatched_request.dispatchFile(null,"index.html",this.addDefaultIndexAttributes({"message":"","plugins":pluginString,"consumer":cs,"consumer_detail":csd}));
	} else 
    ...
    case "/index/?installmode":
	 ...
	 case "/index/?cleanup":
   	    ...
   	    var update = "All connections removed. Please restart your CCU.";

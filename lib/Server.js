...
Server.prototype.handleConfigurationRequest = function(dispatched_request) {
	...
	case "/index/?restart":
   	    this.restart();
    	dispatched_request.dispatchFile(null,"index.html",this.addDefaultIndexAttributes({"message":"Rebooting","link":"#"}));
		cfg_handled = true;
        break;
...
Server.prototype.restart = function() {
  try {	
	require('child_process').execSync('sudo /etc/init.d/hmvi restart')
		return "Restart ....."
	 } catch (e) {
		return "Oh no"
	}

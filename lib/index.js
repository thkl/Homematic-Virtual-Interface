...
var log = require(path.join(__dirname, 'logger.js')).logger("Core");
...
log.info("================================================================");
 ...
 program
    ...
    .option('-D, --debug', 'turn on debug level logging', function() { require(path.join(__dirname, 'logger.js')).setDebugEnabled(true) })
...
var Server = require(path.join(__dirname, 'Server.js')).Server;

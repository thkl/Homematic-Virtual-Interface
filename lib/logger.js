...
var Datastore = require('nedb')
  , db = new Datastore({ filename: logPath + "log.db" , autoload: true });
...
function consoleLog(prefix) {
	...
	log : function() {
		logConsoleString(prefix,3,getRawString(arguments))
	},
	
	info : function() {
        logConsoleString(prefix,2,getRawString(arguments))
	},

	
	warn : function() {
        logConsoleString(prefix,1,getRawString(arguments))
	},
	
	debug : function() {
        if (DEBUG_ENABLED==true) logConsoleString(prefix,4,getRawString(arguments))
	},
	
	error : function() {
        logConsoleString(prefix,0,getRawString(arguments))
	}
  }
}

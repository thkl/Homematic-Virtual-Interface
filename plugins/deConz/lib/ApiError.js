...
const GatewayDeviceError = require(path.join(__dirname, 'GatewayDeviceError.js'))
...
module.exports = class ApiError extends Error {
  constructor (...args) {
    ...
    if (args[0] instanceof GatewayDeviceError) {
      this._hueError = args[0]
      this.message = this._hueError.message
    } else if (args[1] && args[1] instanceof GatewayDeviceError) {

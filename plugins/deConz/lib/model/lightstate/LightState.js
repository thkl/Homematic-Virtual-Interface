...
const CommonStates = require(path.join(__dirname, 'CommonStates.js'))
...
module.exports = class LightState extends CommonStates {
  ...
  hsl (hue, saturation, luminosity) {
    ...
    const satValue = Math.round(200 * temp / (luminosity + temp)) | 0
    const bri = Math.round(temp + luminosity)
